...
/* Artikelbild - eigene Zeichnung, kein Foto. Siehe Kommentar in BILDER. */
.rg-bild{display:block;width:100%;height:auto;border-radius:var(--radius);margin:0 0 34px}
.rg-eintrag .rg-bild{margin:-28px -30px 18px;width:calc(100% + 60px);border-radius:var(--radius) var(--radius) 0 0}
...
ARTIKEL = [
{
 ...
 "bild": """<svg class="rg-bild" viewBox="0 0 800 300" role="img" aria-label="Links ein alter Heizkessel, rechts eine Waermepumpe, dazwischen ein Pfeil">
        <rect width="800" height="300" rx="18" fill="var(--forest-soft)"/>
        <path d="M56 252 H744" stroke="var(--forest)" stroke-width="2.5" stroke-linecap="round" opacity=".4"/>
        <g stroke="var(--forest)" stroke-width="4" fill="var(--white)" stroke-linejoin="round" stroke-linecap="round">
          <path d="M188 78 V52 h84"/>
          <rect x="140" y="78" width="128" height="174" rx="10"/>
          <rect x="164" y="186" width="80" height="44" rx="7" fill="var(--amber-soft)"/>
        </g>
        <path d="M206 222c9-13 7-24-2-33 1 10-6 14-10 21-4 8 1 15 12 12z" fill="var(--amber)"/>
        <g stroke="var(--forest)" stroke-width="4" stroke-linecap="round" opacity=".45">
          <path d="M164 112 H244"/><path d="M164 138 H212"/>
        </g>
        <g stroke="var(--amber)" stroke-width="7" stroke-linecap="round" stroke-linejoin="round" fill="none">
          <path d="M320 165 H454"/><path d="M430 141 L458 165 L430 189"/>
        </g>
        <g stroke="var(--forest)" stroke-width="4" fill="var(--white)" stroke-linejoin="round">
          <rect x="516" y="112" width="176" height="140" rx="12"/>
          <circle cx="604" cy="182" r="44"/>
        </g>
        <g stroke="var(--amber)" stroke-width="6" stroke-linecap="round" fill="none">
          <path d="M604 148 a34 34 0 0 1 29 51"/>
          <path d="M604 216 a34 34 0 0 1 -29 -51"/>
        </g>
        <circle cx="604" cy="182" r="9" fill="var(--forest)"/>
      </svg>""",
...
},
{
 ...
 "bild": """<svg class="rg-bild" viewBox="0 0 800 300" role="img" aria-label="Haus mit drei nummerierten Schritten: erst Dach, dann Fassade, zuletzt Heizung">
        <rect width="800" height="300" rx="18" fill="var(--forest-soft)"/>
        <path d="M180 258 H620" stroke="var(--forest)" stroke-width="2.5" stroke-linecap="round" opacity=".4"/>
        <g stroke="var(--forest)" stroke-width="4.5" fill="var(--white)" stroke-linejoin="round" stroke-linecap="round">
          <path d="M264 256 V134 L400 44 L536 134 V256 Z"/>
          <path d="M264 134 H536"/>
          <rect x="356" y="184" width="88" height="72" rx="6" fill="var(--amber-soft)"/>
        </g>
        <path d="M424 100 C486 120 516 146 522 168" fill="none" stroke="var(--amber)" stroke-width="3.5" stroke-dasharray="8 11" stroke-linecap="round"/>
        <path d="M496 214 C468 228 448 226 430 222" fill="none" stroke="var(--amber)" stroke-width="3.5" stroke-dasharray="8 11" stroke-linecap="round"/>
        <g font-family="Roboto,Arial,sans-serif" font-size="30" font-weight="700" text-anchor="middle">
          <circle cx="400" cy="80" r="29" fill="var(--amber)"/><text x="400" y="91" fill="#FFFFFF">1</text>
          <circle cx="504" cy="192" r="29" fill="var(--amber)"/><text x="504" y="203" fill="#FFFFFF">2</text>
          <circle cx="400" cy="220" r="29" fill="var(--forest)"/><text x="400" y="231" fill="#FFFFFF">3</text>
        </g>
      </svg>""",
 "rubrik": "Strategie",
...
},
{
 ...
 "bild": """<svg class="rg-bild" viewBox="0 0 800 300" role="img" aria-label="Weggabelung: links ein Muenzstapel für den Zuschuss, rechts ein Formular für die Steuerermaessigung">
        <rect width="800" height="300" rx="18" fill="var(--forest-soft)"/>
        <path d="M400 272 V198" stroke="var(--forest)" stroke-width="7" stroke-linecap="round"/>
        <path d="M400 198 C400 154 340 146 286 132" fill="none" stroke="var(--amber)" stroke-width="7" stroke-linecap="round"/>
        <path d="M400 198 C400 154 460 146 514 132" fill="none" stroke="var(--forest)" stroke-width="7" stroke-linecap="round" stroke-dasharray="15 14"/>
        <g stroke="var(--forest)" stroke-width="4" stroke-linejoin="round">
          <path d="M172 62 V112 a54 19 0 0 0 108 0 V62" fill="var(--white)"/>
          <path d="M172 88 a54 19 0 0 0 108 0" fill="none"/>
          <ellipse cx="226" cy="62" rx="54" ry="19" fill="var(--amber-soft)"/>
        </g>
        <text x="226" y="72" text-anchor="middle" font-family="Roboto,Arial,sans-serif" font-size="26" font-weight="700" fill="var(--amber-deep)">€</text>
        <g stroke="var(--forest)" stroke-width="4" fill="var(--white)" stroke-linejoin="round">
          <rect x="520" y="40" width="130" height="94" rx="8"/>
        </g>
        <g stroke="var(--forest)" stroke-width="4" stroke-linecap="round" opacity=".5">
          <path d="M542 66 H606"/><path d="M542 86 H628"/>
        </g>
        <text x="596" y="120" text-anchor="middle" font-family="Roboto,Arial,sans-serif" font-size="26" font-weight="700" fill="var(--amber-deep)">20 %</text>
      </svg>""",
 "rubrik": "Förderung",
...
},
{
 ...
 "bild": """<svg class="rg-bild" viewBox="0 0 800 300" role="img" aria-label="Querschnitt: warmer Wohnraum oben, gedaemmte Kellerdecke in der Mitte, kuehler Keller darunter">
        <rect width="800" height="300" rx="18" fill="var(--forest-soft)"/>
        <rect x="150" y="44" width="500" height="108" fill="var(--amber-soft)" stroke="var(--forest)" stroke-width="4"/>
        <g stroke="var(--forest)" stroke-width="4" fill="var(--white)"><rect x="196" y="82" width="78" height="58" rx="6"/></g>
        <g stroke="var(--forest)" stroke-width="3.5" opacity=".5"><path d="M222 90 V132"/><path d="M248 90 V132"/></g>
        <g stroke="var(--amber-deep)" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none">
          <path d="M430 136 V80"/><path d="M414 94 L430 76 L446 94"/>
          <path d="M520 136 V80"/><path d="M504 94 L520 76 L536 94"/>
        </g>
        <rect x="150" y="152" width="500" height="42" fill="var(--amber)"/>
        <g stroke="#FCF4E8" stroke-width="4" opacity=".7">
          <path d="M178 194 L206 152"/><path d="M238 194 L266 152"/><path d="M298 194 L326 152"/>
          <path d="M358 194 L386 152"/><path d="M418 194 L446 152"/><path d="M478 194 L506 152"/>
          <path d="M538 194 L566 152"/><path d="M598 194 L626 152"/>
        </g>
        <rect x="150" y="152" width="500" height="42" fill="none" stroke="var(--forest)" stroke-width="4"/>
        <rect x="150" y="194" width="500" height="68" fill="var(--white)" stroke="var(--forest)" stroke-width="4"/>
        <text x="400" y="238" text-anchor="middle" font-family="Roboto,Arial,sans-serif" font-size="22" font-weight="700" fill="var(--muted)" letter-spacing="4">KELLER</text>
      </svg>""",
...
},
{
 ...
 "bild": """<svg class="rg-bild" viewBox="0 0 800 300" role="img" aria-label="Landschaft: Albhochflaeche mit Haus, davor das Donautal mit dem Fluss">
        <rect width="800" height="300" rx="18" fill="var(--forest-soft)"/>
        <circle cx="686" cy="66" r="26" fill="var(--amber)" opacity=".85"/>
        <path d="M44 212 H228 L352 120 H756" fill="none" stroke="var(--forest)" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/>
        <g stroke="var(--forest)" stroke-width="4.5" fill="var(--white)" stroke-linejoin="round" stroke-linecap="round">
          <path d="M448 120 V70 L502 30 L556 70 V120"/>
          <path d="M448 70 H556"/>
        </g>
        <g fill="var(--forest)" opacity=".75">
          <path d="M612 120 L636 64 L660 120 Z"/>
          <path d="M680 120 L698 80 L716 120 Z"/>
        </g>
        <g stroke="var(--forest)" stroke-width="4" fill="var(--white)" stroke-linejoin="round" stroke-linecap="round" opacity=".5">
          <path d="M92 212 V178 L126 152 L160 178 V212"/>
        </g>
        <path d="M44 266 C152 242 232 288 350 266 C468 244 608 288 756 262" fill="none" stroke="var(--amber)" stroke-width="9" stroke-linecap="round"/>
      </svg>""",
 "rubrik": "Region",
